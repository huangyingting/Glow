...
const MAJOR_SHOWERS: ShowerDefinition[] = [
  { id: "quadrantids", name: "象限仪座流星雨", peakMonth: 1, peakDay: 4, activeStart: [12, 28], activeEnd: [1, 12], zenithalHourlyRate: 120, radiant: "牧夫座北部", radiantRa: 15.33, radiantDec: 49, viewingAdvice: "后半夜辐射点升高，面向东北至天顶的大范围天空观察。" },
  ...
  { id: "orionids", name: "猎户座流星雨", peakMonth: 10, peakDay: 22, activeStart: [10, 2], activeEnd: [11, 7], zenithalHourlyRate: 20, radiant: "猎户座", radiantRa: 6.33, radiantDec: 16, viewingAdvice: "后半夜猎户座升高，镜头避开明月可提升暗流星对比度。" },
  { id: "leonids", name: "狮子座流星雨", peakMonth: 11, peakDay: 18, activeStart: [11, 6], activeEnd: [11, 30], zenithalHourlyRate: 15, radiant: "狮子座", radiantRa: 10.13, radiantDec: 22, viewingAdvice: "黎明前辐射点最高，普通年份不应按历史暴雨强度做期待。" },
  { id: "geminids", name: "双子座流星雨", peakMonth: 12, peakDay: 14, activeStart: [12, 4], activeEnd: [12, 20], zenithalHourlyRate: 120, radiant: "双子座", radiantRa: 7.47, radiantDec: 33, viewingAdvice: "入夜后即可拍摄，午夜前后辐射点更高且持续时间长。" },
];
